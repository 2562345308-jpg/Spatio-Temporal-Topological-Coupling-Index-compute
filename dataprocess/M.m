...
clc;
% 输入和输出的基本路径
inputBasePath = 'G:\Matrixparameter\G11';%%%%%
outputBasePath = 'G:\Meanparameter\G11';%%%%%
...
for i = 1:length(subdirs)
    ...
    if exist(resultsPath, 'dir')
        ...
        if ~isempty(matFiles)
            ...
            % 保存平均值为.mat文件
            outputFilePath = fullfile(outputSubdirPath, sprintf('average_efficiency.mat'));
            save(outputFilePath, 'averageEfficiency');
        end
    end
end
