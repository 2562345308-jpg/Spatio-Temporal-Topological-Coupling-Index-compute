...
for i = 1:length(subdirs)
    ...
    if exist(resultsPath, 'dir')
        ...
        matFiles = dir(fullfile(resultsPath, '*P-P.mat'));
        ...
        if ~isempty(matFiles)
            ...
            for j = 1:length(matFiles)
                ...
                efficiencyValues = [efficiencyValues, data.sum_D]; % 假设.mat文件中的数据在字段"assortativity"中
            end
            ...
            % 保存平均值为.mat文件
            outputFilePath = fullfile(outputSubdirPath, sprintf('average_P-P.mat'));
