...
% Directory paths
baseDir = 'E:\processed_data\T3_part\';
subDirs = {'G0', 'G2', 'G3', 'G8', 'G9'};
%subDirs = {'G0', 'G1', 'G2', 'G3', 'G5', 'G6', 'G8', 'G9'};
filePattern = 'average_pathlength.mat';%%%%
...
for groupIdx = 1:length(subDirs)
    ...
    for subSubDirIdx = 1:length(subSubDirs)
        ...
        if ~isempty(matFiles)
            ...
            pathlengthData = load(matFilePath);
            pathlengthValue = pathlengthData.averagepathlength;%%%%%%%
            
            % Add assortativity value to the respective group's array
            switch groupIdx
                case 1
                    x0 = [x0, pathlengthValue];
                case 2
                    x2 = [x2, pathlengthValue];
                case 3
                    x3 = [x3, pathlengthValue];
                case 4
                    x8 = [x8, pathlengthValue];
                case 5
                    x9 = [x9, pathlengthValue];
            end
        end
    end
end
