...
filePattern = 'average_assortativity.mat';%%%%
...
for groupIdx = 1:length(subDirs)
    ...
    for subSubDirIdx = 1:length(subSubDirs)
        ...
        if ~isempty(matFiles)
            ...
            assortativityData = load(matFilePath);
            assortativityValue = assortativityData.averageAssortativity;%%%%%%%
            
            % Add assortativity value to the respective group's array
            switch groupIdx
                case 1
                    x0 = [x0, assortativityValue];
                case 2
                    x2 = [x2, assortativityValue];
                case 3
                    x3 = [x3, assortativityValue];
                case 4
                    x8 = [x8, assortativityValue];
                case 5
                    x9 = [x9, assortativityValue];
            end
        end
    end
end
