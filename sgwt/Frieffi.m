...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'ratio1_Efficiency.mat'));
matFile2 = load(fullfile(baseDir, 'ratio2_Efficiency.mat'));
matFile3 = load(fullfile(baseDir, 'ratio3_Efficiency.mat'));
matFile4 = load(fullfile(baseDir, 'ratio4_Efficiency.mat'));
matFile5 = load(fullfile(baseDir, 'ratio5_Efficiency.mat'));
x1 = matFile1.ratio1;
x2 = matFile2.ratio2;
x3 = matFile3.ratio3;
x4 = matFile4.ratio4;
