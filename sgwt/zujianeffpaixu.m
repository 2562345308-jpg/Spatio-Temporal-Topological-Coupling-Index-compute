...
% 文件路径和变量名称
filePaths = { ...
    'G:\SGWT1\G2\ratio1_richclub.mat', ...
    'G:\SGWT1\G3\ratio1_richclub.mat', ...
    'G:\SGWT1\G8\ratio1_richclub.mat', ...
    'G:\SGWT1\R06\ratio1_richclub.mat', ...
};
variableNames = {'ratio1', 'ratio1', 'ratio1', 'ratio1'};
labelNames = {'G2ratio1', 'G3ratio1', 'G8ratio1', 'R06ratio1'};
...
for i = 1:numel(filePaths)
    ...
    underBound = Q3 + 1.5 * IQR;
    ratioData = ratioData(ratioData >= lowerBound & ratioData <= underBound);
