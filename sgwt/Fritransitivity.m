...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'ratio1_transitivity.mat'));
matFile2 = load(fullfile(baseDir, 'ratio2_transitivity.mat'));
matFile3 = load(fullfile(baseDir, 'ratio3_transitivity.mat'));
matFile4 = load(fullfile(baseDir, 'ratio4_transitivity.mat'));
matFile5 = load(fullfile(baseDir, 'ratio5_transitivity.mat'));
x1 = matFile1.ratio1;
x2 = matFile2.ratio2;
x3 = matFile3.ratio3;
x4 = matFile4.ratio4;
