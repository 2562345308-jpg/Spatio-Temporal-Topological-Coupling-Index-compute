...
matFile1 = load(fullfile(baseDir1, 'ratio5_richclub.mat'));
matFile2 = load(fullfile(baseDir2, 'ratio5_richclub.mat'));
matFile3 = load(fullfile(baseDir3, 'ratio5_richclub.mat'));
matFile4 = load(fullfile(baseDir4, 'ratio5_richclub.mat'));
