...
% 文件路径和变量名称
filePaths = { ...
    'G:\situation2\R06\ratio1_richclub.mat', ...
    'G:\situation2\R06\ratio2_richclub.mat', ...
    'G:\situation2\R06\ratio3_richclub.mat', ...
    'G:\situation2\R06\ratio4_richclub.mat', ...
    'G:\situation2\R06\ratio5_richclub.mat' ...
};
...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'ratio1_richclub.mat'));
matFile2 = load(fullfile(baseDir, 'ratio2_richclub.mat'));
matFile3 = load(fullfile(baseDir, 'ratio3_richclub.mat'));
matFile4 = load(fullfile(baseDir, 'ratio4_richclub.mat'));
matFile5 = load(fullfile(baseDir, 'ratio5_richclub.mat'));
x1 = matFile1.ratio1;
x2 = matFile2.ratio2;
x3 = matFile3.ratio3;
x4 = matFile4.ratio4;
