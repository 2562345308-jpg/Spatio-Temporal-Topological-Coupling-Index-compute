...
% 文件路径和变量名称
filePaths = { ...
    'G:\SGWT1\R06\ratio1_CP.mat', ...
    'G:\SGWT1\R06\ratio2_CP.mat', ...
    'G:\SGWT1\R06\ratio3_CP.mat', ...
    'G:\SGWT1\R06\ratio4_CP.mat', ...
    'G:\SGWT1\R06\ratio5_CP.mat' ...
};
...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'ratio1_CP.mat'));
matFile2 = load(fullfile(baseDir, 'ratio2_CP.mat'));
matFile3 = load(fullfile(baseDir, 'ratio3_CP.mat'));
matFile4 = load(fullfile(baseDir, 'ratio4_CP.mat'));
matFile5 = load(fullfile(baseDir, 'ratio5_CP.mat'));
x1 = matFile1.ratio1;
x2 = matFile2.ratio2;
x3 = matFile3.ratio3;
x4 = matFile4.ratio4;
