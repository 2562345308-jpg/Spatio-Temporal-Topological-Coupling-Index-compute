...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'N1_PP.mat'));
matFile2 = load(fullfile(baseDir, 'N2_PP.mat'));
matFile3 = load(fullfile(baseDir, 'N3_PP.mat'));
matFile4 = load(fullfile(baseDir, 'R_PP.mat'));
matFile5 = load(fullfile(baseDir, 'W_PP.mat'));
x1 = matFile1.allData;
x2 = matFile2.allData;
x3 = matFile3.allData;
x4 = matFile4.allData;
