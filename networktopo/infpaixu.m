...
%variableNames = {a, a, a, a};
variableNums = {[a '_CC'], [a '_CP'], [a '_PC'], [a '_PP']};
% 初始化数据存储
...
matFile1 = load(fullfile(baseDir, 'W_CC.mat'));
matFile2 = load(fullfile(baseDir, 'W_CP.mat'));
matFile3 = load(fullfile(baseDir, 'W_PC.mat'));
matFile4 = load(fullfile(baseDir, 'W_PP.mat'));
