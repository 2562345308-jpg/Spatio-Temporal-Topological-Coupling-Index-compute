...
% 文件路径和变量名称
filePaths = { ...
    'G:\nettp\R06\N1_efficiency.mat', ...
    'G:\nettp\R06\N2_efficiency.mat', ...
    'G:\nettp\R06\N3_efficiency.mat', ...
    'G:\nettp\R06\R_efficiency.mat', ...
    'G:\nettp\R06\W_efficiency.mat' ...
};
...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'N1_efficiency.mat'));
matFile2 = load(fullfile(baseDir, 'N2_efficiency.mat'));
matFile3 = load(fullfile(baseDir, 'N3_efficiency.mat'));
matFile4 = load(fullfile(baseDir, 'R_efficiency.mat'));
matFile5 = load(fullfile(baseDir, 'W_efficiency.mat'));
x1 = matFile1.allData;
x2 = matFile2.allData;
x3 = matFile3.allData;
x4 = matFile4.allData;
