...
% 文件路径和变量名称
filePaths = { ...
    'G:\nettp\G2\R_richclub.mat', ...
    'G:\nettp\G3\R_richclub.mat', ...
    'G:\nettp\G8\R_richclub.mat', ...
    'G:\nettp\R06\R_richclub.mat', ...
};
variableNames = {'allData', 'allData', 'allData', 'allData'};
...
xlabel('Ratio');
ylabel('Ratio Values');
saveas(gcf, 'G:\画图\替代检验\网络拓扑图\Rrichclub.png');
