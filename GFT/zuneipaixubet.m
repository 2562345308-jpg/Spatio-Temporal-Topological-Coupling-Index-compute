...
% 文件路径和变量名称
filePaths = { ...
    'G:\gft\R06\ratio1_betweenness14.mat', ...
    'G:\gft\R06\ratio2_betweenness14.mat', ...
    'G:\gft\R06\ratio3_betweenness14.mat', ...
    'G:\gft\R06\ratio4_betweenness14.mat', ...
    'G:\gft\R06\ratio5_betweenness14.mat' ...
};
variableNames = {'ratio1', 'ratio2', 'ratio3', 'ratio4', 'ratio5'};
...
x4 = [];
x5 = [];
matFile1 = load(fullfile(baseDir, 'ratio1_betweenness14.mat'));
matFile2 = load(fullfile(baseDir, 'ratio2_betweenness14.mat'));
matFile3 = load(fullfile(baseDir, 'ratio3_betweenness14.mat'));
matFile4 = load(fullfile(baseDir, 'ratio4_betweenness14.mat'));
matFile5 = load(fullfile(baseDir, 'ratio5_betweenness14.mat'));
x1 = matFile1.ratio1;
x1 = log(x1);
x2 = matFile2.ratio2;
x2 = log(x2);
